        ...
        if(correo != ""){
            ...
            if(regex.test(correo)){
                if(msg != ""){
                    ...
                    $("#contenedor").append("<div class='col d-flex justify-content-center'><a class='btn boton mt-4' href='{% url 'inicio' %}' style='margin-right: 5px;'><b>DameVino</b></a><a class='btn boton mt-4' href='{% url 'contacto' %}' style='margin-left: 5px'><b>Contacto</b></a></div>")
                }
                else
